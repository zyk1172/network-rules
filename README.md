...
- `sources/upstreams.json`：登记 MetaCubeX/meta-rules-dat 和 blackmatrix7/ios_rule_script 的公开源、格式、许可证和适配路径；AI 规则只按白名单接入 ChatGPT、Claude 与 Gemini，BlackMatrix7 另外提供 PT、Netflix 与最后兜底的国外网站泛分类。
